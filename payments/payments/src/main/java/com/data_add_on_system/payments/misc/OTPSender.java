...
public class OTPSender {
    ...
    public boolean sendSms(String recieptPhoneNumber, String content){
        try {
            Message.creator(new PhoneNumber("+91"+recieptPhoneNumber), new PhoneNumber(twilioPhoneNumber), "Recharge Successful: " + content
